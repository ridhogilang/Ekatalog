...
@section('container')
    <div class="form-container">
        <div class="title">Update Data Sparepart</div>
        ...
        <br>
        <br>
        <form action="/updatepart" method="POST" enctype="multipart/form-data">
            @method('put')
            @csrf
                ...
                <select id="mobil_id" name="mobil_id" required>
                    ...
                    @foreach ($allmobil as $item)
                        <option value="{{ $item->id }}"
                            {{ $item->id == old('mobil_id', $mobil->mobil_id) ? 'selected' : '' }}>
                            {{ $item->mobil }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select id="jenispart_id" name="jenispart_id" required>
                    ...
                    @foreach ($allpart as $item)
                        <option value="{{ $item->id }}"
                            {{ $item->id == old('jenispart_id', $mobil->jenispart_id) ? 'selected' : '' }}>
                            {{ $item->nama }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama" name="nama" required value="{{ old('nama', $mobil->nama) }}">
            </div>
            <div class="form-group">
                <label for="merek">Merk Sparepart:</label>
                <input type="text" id="merek" name="merek" required value="{{ old('merek', $mobil->merek) }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea type="text" id="detail" name="detail" required>{{ old('detail', $mobil->detail) }}</textarea>
            </div>
            <div class="form-group">
