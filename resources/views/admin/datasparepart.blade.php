            ...
            <div style="width: 100%; justify-content: center;">
                <div>
                                ...
                                <table id="dataTable">
                                    ...
                                    @foreach ($mobil as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->mobil->mobil }}</td>
                                            <td>{{ $item->jenispart->nama }}</td>
                                            <td>{{ $item->nama }}</td>
                                            <td>{{ $item->merek }}</td>
                                            <td>Rp. {{ number_format($item->harga, 0, ',', '.') }}</td>
                                            <td class="role">
                                                <a href="/sparepart/editpart/{{ $item->id }}" class="action-btn edit-btn"><i
                                                        class="fas fa-edit"></i></a>
                                                <form id="delete-form" action="/deletepart/{{ $item->id }}"
                                                    method="POST">
                                                    @method('delete')
                                                    @csrf
                    ...
                    <div class="button-container">
                        ...
                        <a href="/sparepart/create" class="button">Tambah Data</a>
                    </div>
                </div>
            </div>
        </div>
