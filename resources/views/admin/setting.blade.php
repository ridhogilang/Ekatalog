        ...
        <div style="width: 100%; display: flex; justify-content: center;">
            <div>
                <div style="display: flex; justify-content: center;">
                    <img src="{{ asset('image/setting.png') }}" alt="Gambar 1" class="box-image" style="width: 30%; max-height: 100%;">
                </div><br>
                <div class="box-caption">Halaman Setting</div>
                <div class="top-container">
                    <div class="deskripsi-box">
                        <h2>Sorry</h2>
                        <h4>Hello, {{ auth()->user()->username }}. <br> Mohon maaf untuk halaman setting masih dalam proses pengembangan.</h4>
                        <br><p>E-Katalog</p>
                    </div>
                </div>
